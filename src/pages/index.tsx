...
export const getStaticProps = async () => {
  ...
  const skillWithData = objectData.skill.map(async (item: SkillProps) => {
  ...
  return {
    props: {
      ...
      skill: await Promise.all(skillWithData),
    },
  };
};
...
const getMd = async ({
  ...
  section: string;
  item: InformationProps | ProjectProps | WorkExperienceProps | SkillProps;
}) => {
  try {
